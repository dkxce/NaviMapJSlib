...
********************************************************
  * NaviMap JSLib
  * Copyrights (с) 2009-2017 milokz[at]gmail[dot]com
********************************************************
********************************************************/
		...
		include("navimap/js/jquery.js");
			...
			{							
				var thisObj = this;
				(new Function('sender','document.NaviMap_'+map_div_id+' = sender;'))(this); 
				
				//const
				thisObj.image_overflow = 40;
				thisObj.lockable_array = [false,false];
				...
				thisObj.Assembly = { Title:'NaviMap',Description:'NaviMap JavaScript Library',Configuration:'',Company:'',Product:'NaviMap JSLib',Copyright:'Copyright © milokz[at]gmail[dot]com 2017',Trademark:'',Author:'MZ',Version:'0.2.7.15 MSMC Edition',VersionDate:'21.10.2015' };
				...
				thisObj.Events =
				{
					Global:
					{
						onMouseMove: thisObj.EventListener.AddEvent('Events.Global.onMouseMove'), 
						onMouseUp: thisObj.EventListener.AddEvent('Events.Global.onMouseUp'), 
						onMouseDown: thisObj.EventListener.AddEvent('Events.Global.onMouseDown'), 
						onMouseClick: thisObj.EventListener.AddEvent('Events.Global.onMouseClick'), 
						onContextMenu: thisObj.EventListener.AddEvent('Events.Global.onContextMenu'), 
						onScroll: thisObj.EventListener.AddEvent('Events.Global.onScroll') 
					},
					Map:
					{
						onloadimage: thisObj.EventListener.AddEvent('Events.Map.onloadimage'), 
						onRedrawVector: thisObj.EventListener.AddEvent('Events.Map.onRedrawVector'), 
						onChangeTool: thisObj.EventListener.AddEvent('Events.Map.onChangeTool'), 
						onMouseClick: thisObj.EventListener.AddEvent('Events.Map.onMouseClick') 
					}
				};
				...
				thisObj.XYZ = { index: 0, x: 0, y: 0, z: 0, zoom: 0, zoomID: 0 };
				...
				[
					{   
						...
						DefaultTileUrlPage: "../getMapWMS.ashx?key=TEST",
				...
				{		
					...
					thisObj.XYZ.zoom = thisObj.XYZ.z/(thisObj.width+thisObj.image_overflow); 
				...
				// private
				thisObj.Copyrght_Prefix = thisObj.Assembly.Title+' '+thisObj.Assembly.Version + ' &copy; ' + thisObj.Assembly.Author + ' 2017';
		...
		else if (document.attachEvent) { document.attachEvent("onreadystatechange", function() { if ( document.readyState === "complete" )  
		{ document.detachEvent( "onreadystatechange", arguments.callee ); document.dkxce_onload(); }; }) }
		else window.onload = function() { includeDone(); }; 